...
```js
import { addEventListener } from "@outdoormap/frontend-utils/js/event";
```
...
4. Edit `/js`, make sure the corresponding examples on `demo` are updated/added

## Documentation

### [_animation.js_](/OutdoorMap/frontend-utils/blob/main/js/animation.js)
...
### [_attribute.js_](/OutdoorMap/frontend-utils/blob/main/js/attribute.js)
...
### [_cookie.js_](/OutdoorMap/frontend-utils/blob/main/js/cookie.js)
...
### [_event.js_](/OutdoorMap/frontend-utils/blob/main/js/event.js)
...
### [_load-script.js_](/OutdoorMap/frontend-utils/blob/main/js/load-script.js)
...
### [_position.js_](/OutdoorMap/frontend-utils/blob/main/js/position.js)
...
### [_promise.js_](/OutdoorMap/frontend-utils/blob/main/js/promise.js)
...
### [_selector.js_](/OutdoorMap/frontend-utils/blob/main/js/selector.js)
...
### [_smart-outline.js_](/OutdoorMap/frontend-utils/blob/main/js/smart-outline.js)
